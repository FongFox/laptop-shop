                    ...
                    <div class="row g-4 fruite">
                        ...
                        <div class="col-12 col-md-9 text-center">
                            <div class="row g-4">
                                ...
                                <%-- Pagination start --%>
                                <nav class="pagination d-flex justify-content-center mt-5"
                                     aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center d-flex">
                                        <li class="page-item">
                                            <a class="page-link"
                                               href="/products?page=${1 eq currentPage ? 1 : currentPage - 1}"
                                               aria-label="Previous">
                                        ...
                                        <li class="page-item">
                                            <a class="page-link"
                                               href="/products?page=${currentPage eq totalPages ? currentPage : currentPage + 1}"
                                               aria-label="Next">
